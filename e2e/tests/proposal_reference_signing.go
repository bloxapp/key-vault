...
func referenceBlock(t *testing.T) *api.VersionedProposal {
...
func (test *ProposalReferenceSigning) serializedReq(pk, root []byte, domain [32]byte, blk *api.VersionedProposal) (map[string]interface{}, error) {
